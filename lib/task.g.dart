...
const TaskSchema = CollectionSchema(
  ...
  properties: {
    r'blockedByTaskId': PropertySchema(
      id: 0,
      name: r'blockedByTaskId',
      type: IsarType.long,
    ),
...
void _taskSerialize(
  ...
  writer.writeLong(offsets[0], object.blockedByTaskId);
...
Task _taskDeserialize(
  ...
  final object = Task(
    blockedByTaskId: reader.readLongOrNull(offsets[0]),
    description: reader.readString(offsets[1]),
    dueDate: reader.readDateTime(offsets[2]),
    id: id,
    status: _TaskstatusValueEnumMap[reader.readByteOrNull(offsets[3])] ??
        TaskStatus.todo,
...
extension TaskQueryFilter on QueryBuilder<Task, Task, QFilterCondition> {
  QueryBuilder<Task, Task, QAfterFilterCondition> blockedByTaskIdIsNull() {
    return QueryBuilder.apply(this, (query) {
      return query.addFilterCondition(const FilterCondition.isNull(
        property: r'blockedByTaskId',
      ));
    });
  }

  QueryBuilder<Task, Task, QAfterFilterCondition> blockedByTaskIdIsNotNull() {
    return QueryBuilder.apply(this, (query) {
  ...
  QueryBuilder<Task, Task, QAfterFilterCondition> blockedByTaskIdEqualTo(
      int? value) {
    return QueryBuilder.apply(this, (query) {
  ...
  QueryBuilder<Task, Task, QAfterFilterCondition> blockedByTaskIdGreaterThan(
    int? value, {
    bool include = false,
  }) {
    return QueryBuilder.apply(this, (query) {
  ...
  QueryBuilder<Task, Task, QAfterFilterCondition> blockedByTaskIdLessThan(
    int? value, {
    bool include = false,
  }) {
    return QueryBuilder.apply(this, (query) {
  ...
  QueryBuilder<Task, Task, QAfterFilterCondition> blockedByTaskIdBetween(
    int? lower,
    int? upper, {
    bool includeLower = true,
    bool includeUpper = true,
...
extension TaskQuerySortBy on QueryBuilder<Task, Task, QSortBy> {
  QueryBuilder<Task, Task, QAfterSortBy> sortByBlockedByTaskId() {
    return QueryBuilder.apply(this, (query) {
      return query.addSortBy(r'blockedByTaskId', Sort.asc);
    });
  }

  QueryBuilder<Task, Task, QAfterSortBy> sortByBlockedByTaskIdDesc() {
    return QueryBuilder.apply(this, (query) {
      return query.addSortBy(r'blockedByTaskId', Sort.desc);
    });
  }
...
extension TaskQuerySortThenBy on QueryBuilder<Task, Task, QSortThenBy> {
  QueryBuilder<Task, Task, QAfterSortBy> thenByBlockedByTaskId() {
    return QueryBuilder.apply(this, (query) {
      return query.addSortBy(r'blockedByTaskId', Sort.asc);
    });
  }

  QueryBuilder<Task, Task, QAfterSortBy> thenByBlockedByTaskIdDesc() {
    return QueryBuilder.apply(this, (query) {
      return query.addSortBy(r'blockedByTaskId', Sort.desc);
    });
  }
...
extension TaskQueryWhereDistinct on QueryBuilder<Task, Task, QDistinct> {
  QueryBuilder<Task, Task, QDistinct> distinctByBlockedByTaskId() {
    return QueryBuilder.apply(this, (query) {
      return query.addDistinctBy(r'blockedByTaskId');
    });
  }
...
extension TaskQueryProperty on QueryBuilder<Task, Task, QQueryProperty> {
  ...
  QueryBuilder<Task, int?, QQueryOperations> blockedByTaskIdProperty() {
    return QueryBuilder.apply(this, (query) {
      return query.addPropertyName(r'blockedByTaskId');
    });
  }
